...
const ClubMoreDetail = ({ rawDatateam }) => {
        ...
        <div className="stake-top-channel-i-d5">
          ...
          <div className="stake-top-channel-i-d">
            ...
            <div className="Darts-style2">
              ...
              <div className="joined1">
                ...
                <span>  My Status </span>{" "}<span className="joined2" style={{marginLeft:'4px'}}> Member </span>
                </div>
              </div>
              <div className="joined1">
                <div className="joined1">
                  {" "}
                 <span> joined Member </span>{" "}<span className="joined2" style={{marginLeft:'4px'}}>{" "} 200 </span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="stackabout">
            ...
            <p className="stackabout2">
              ...
              Vashundra Enclave Xxxxx Xxxxx Xxxx Delhi Vashundra Enclave Xxxxx
              Xxxxx Xxxx <span className="stackabout3">More...</span>
            </p>
          </div>
