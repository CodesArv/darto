...
const EditTeam = () => {
  ...
  const GetByIdTeamData = async () => {
    const res = await apiHandler({
      url: endpoint.GETBYID_TEAM + params.id,
      method: "GET",
      data: null,
    });
    console.log(res.data.response);
    setAgeGroup(res.data.response.ageGroup);
    setNameofTeam(res.data.response.nameofTeam);
    setStreet(res.data.response.street);
    setTotalMembers(res.data.response.totalMembers);
    setAbout(res.data.response.about);
    setPincode(res.data.response.pincode);
    setAge(res.data.response.age);
    // setbyid(res.data.response.id);
    setOccupation(res.data.response.occupation);
    setLocality(res.data.response.locality);
    setDistrict(res.data.response.district);
  };
